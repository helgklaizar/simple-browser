# Codex Project Context: simple-browser

Zone: WORK
Path: /Users/klaizar/Projects/WORK/simple-browser

## Purpose

Working pure Swift/WebKit lightweight macOS browser prototype.

## Risk Posture

Working prototype: keep it tiny and native; avoid Chromium/Electron/Tauri-style bloat.
...
- **Стек:** Pure Swift, SwiftUI, AppKit, WebKit
- **Подход:** Ultra-lightweight native macOS web viewer. No Xcode bloat, built via CLI.

## Key Patterns

1. **Local Native First:** Must use `WKWebView` and pure Swift. No Chromium, no Electron/Tauri bloat.
2. **Simplicity:** Keep the UI minimal (HiddenTitleBarWindowStyle) and performance high. Do not over-engineer features.
